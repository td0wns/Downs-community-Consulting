...
export default function CommunityFunnel() {
  return <EditorialPage
    ...
    intro="A conventional funnel follows movement toward a transaction. The community funnel follows a different progression: the growth of familiarity, participation and shared trust."
    backHref="/community" backLabel="The community approach"
    nextHref="/about" nextLabel="About DCC"
    sections={[
      { heading: 'Five changes in the relationship', paragraphs: ['The stages are not a rigid checklist. They describe an increasing willingness to take part, and help an organisation notice where it is asking for commitment before sufficient familiarity exists.'], list: ['Awareness — I recognise that this network exists', 'Interaction — I make a first meaningful contact', 'Engagement — I choose to take part again', 'Buy-in — I invest trust, time or identity in the relationship', 'Advocacy — I carry that confidence into another network'] },
