...
export default function CommunicationInfrastructure() {
  return <EditorialPage
    ...
    sections={[
      ...
      { heading: 'Information and belief travel differently', paragraphs: ['A campaign distributes a message from an organisation to an individual. Inside a community, that message is interpreted through shared experience and discussed by people who already have relationships with one another.', 'This does not make community automatically truthful or positive. It makes the transmission mechanism different. Familiarity and peer validation can lower resistance, while poor experience can travel through the same network just as quickly.'], quote: 'Marketing creates a touchpoint. Trust determines how much weight that touchpoint carries.' },
      ...
      { heading: 'Why this matters to Salesforce architecture', paragraphs: ['A platform sees fields, activities and object relationships. People experience reputation, memory and the opinions of others. Neither view is sufficient alone.', 'Community thinking helps DCC identify the context that deserves a structured signal: a trusted referral, activity elsewhere in an account, a partner relationship or an internal hand-off. The goal is not to digitise every human interaction. It is to stop treating the interactions that matter as if they do not exist.'] },
    ]}
  />;
}
